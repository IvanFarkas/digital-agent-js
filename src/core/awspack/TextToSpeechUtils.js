...
export class TextToSpeechUtils {
   ...
   *  }
   * @param {Array.<string>} [randomMarks = []] - If there are sentences that don't match any words from the map object, marks from this array will be randomly chosen and inserted.
   *
   ...
   *
   * @param {string} text - Input string.
   * @param {Array.<string>} marks - Any array of random SSML marks to choose from when modifying the text.
   *
   * @returns {string}
   */
   ...
   * @param {Array.<string>} [marks = []] - An array of mark strings to choose from when inserting random marks.
   *
   * @returns {string} - Updated input string.
   */
