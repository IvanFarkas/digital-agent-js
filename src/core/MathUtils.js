...
export class MathUtils {
   ...
   *
   * @returns {Array.<number>} - List of sorted indices.
   */
   ...
   *
   * @param {Array.<number>} vector3 - Array consisting of 3 numbers representing a direction vector.
   * @param {Array.<number>} matrix3 - An array of 9 numbers representing a row major rotation matrix.
   *
   * @returns {Array.<number>} - An array of 3 numbers representing the new direction of the vector.
   */
   ...
   *
   * @param {Array.<number>} matrix4 - An array of 16 numbers representing a row major transformation matrix.
   *
   * @returns {Array.<number>} - An array of 9 numbers representing a row major rotation matrix.
   */
   ...
   *
   * @returns {Array.<number>} - An array consisting of three numberes where index 0 represents the radius, index 1 represents the vertical/polar angle in radians and index 2 represents the horizontal/azimuthal angle in radians.
   */
   ...
   * @param {Array.<number>} [valueStore = [0, 0]] - An Array consisting of two numbers where the first number holds the result value and the second holds the velocity that resulted in that value. The same array should be provided with each call to this function.
