...
export class Blend1dState extends AbstractBlendState {
   ...
   * @param {Array.<number>} [blendStates=[]] - Blend states to be controlled by this container.
   * @param {Array.<number>} [blendThresholds=[]] - Threshold values for activating each blend state.
