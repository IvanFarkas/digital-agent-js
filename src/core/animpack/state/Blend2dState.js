...
export class Blend2dState extends AbstractBlendState {
   ...
   * @param {Array.<AbstractBlendState>} [blendStates=[]] - Blend states to be controlled by this container.
   * @param {Array.<Array.<number>>} [blendThresholds=[]] - Threshold values for activating each blend state.
   * @param {Array.<boolean>} [phaseMatches=[]] - Booleans indicating whether or not each blend state should be phase matched.
   */
   ...
   *
   * @param {Array.<Array.<number>>} triangle - Set of triangluated indices that correspond to blend thresholds.
   ...
   *
   * @param {Array.<AbstractBlendState>} states - States to check phase-matching criteria.
