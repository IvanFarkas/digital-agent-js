...
export class PointOfInterestFeature extends AbstractHostFeature.mix(SSMLSpeechmarkInterface.Mixin, ManagedAnimationLayerInterface.Mixin) {
   ...
   *
   * @returns {Array.<number>} - An array consisting of three numbers representing x, y and z coordinates.
   */
   ...
   *
   * @returns {Array.<number>} - An array consisting of 16 numbers representing the 3d transformation.
   */
   ...
   *
   * @param {any} obj - Engine-specific 3D transform object.
   * @param {Array.<number>} forwardVector - Unit vector representing the local forward direction of the object.
   *
